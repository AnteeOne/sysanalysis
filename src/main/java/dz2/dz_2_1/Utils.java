...
public class Utils {
    ...
    public static byte[] getHash(BlockInfo blockInfo) throws NoSuchAlgorithmException, UnsupportedEncodingException, NoSuchProviderException {
        ...
        byte[] result = digest.digest(concat(blockInfo.getPrevHash(), info.getBytes(StandardCharsets.UTF_8)));
        return result;
    }

    public static byte[] getHash(dz2.dz2_2.BlockInfo blockInfo) throws NoSuchAlgorithmException, UnsupportedEncodingException, NoSuchProviderException {
    ...
    public static KeyPair loadKeys() throws Exception {
        ...
        byte[] publicKeyHex = Files.readAllBytes(Paths.get("/Users/antee/Documents/Projects/Kotlin/KFU/sysanalysis/src/main/java/dz2/dz_2_1/public.key"));
        byte[] privateKeyHex = Files.readAllBytes(Paths.get("/Users/antee/Documents/Projects/Kotlin/KFU/sysanalysis/src/main/java/dz2/dz_2_1/private.key"));
