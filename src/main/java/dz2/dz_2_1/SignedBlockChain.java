    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            try (Connection con = DriverManager
                ...
                System.out.println("verification result before: " + verification());

                damage();

                System.out.println("Reading from the database" + verification());
            ...
            System.out.println("verification result after: " + verification());
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
